...
read_log(a)
#> [1] "Complete log:"                                   
#> [2] "✔ sqrt() ran successfully at 2022-05-10 21:54:30"
#> [3] "Total running time: 0.000394344329833984 secs"
```
...
#> [1] "Complete log:"                                   
#> [2] "✔ sqrt() ran successfully at 2022-05-10 21:54:30"
#> [3] "✔ exp() ran successfully at 2022-05-10 21:54:30" 
#> [4] "✔ mean() ran successfully at 2022-05-10 21:54:30"
#> [5] "Total running time: 0.0217418670654297 secs"
...
read_log(output)
#> [1] "Complete log:"                                                                
#> [2] "✔ select(height,mass,species,sex) ran successfully at 2022-05-10 21:54:30"    
#> [3] "✔ group_by(species,sex) ran successfully at 2022-05-10 21:54:30"              
#> [4] "✔ filter(sex != \"male\") ran successfully at 2022-05-10 21:54:30"            
#> [5] "✔ summarise(mean(mass, na.rm = TRUE)) ran successfully at 2022-05-10 21:54:30"
#> [6] "Total running time: 0.124610424041748 secs"
```
...
#> [1] "Complete log:"                                                                                                                                                    
#> [2] "✔ select(height,mass,species,sex) ran successfully at 2022-05-10 21:54:30"                                                                                        
#> [3] "✘ group_by(species,sx) ran unsuccessfully with following exception: Must group by variables found in `.data`.\n✖ Column `sx` is not found. at 2022-05-10 21:54:30"
#> [4] "✘ filter(sex != \"male\") ran unsuccessfully with following exception: Pipeline failed upstream at 2022-05-10 21:54:30"                                           
#> [5] "✘ summarise(mean(mass, na.rm = TRUE)) ran unsuccessfully with following exception: Pipeline failed upstream at 2022-05-10 21:54:30"                               
#> [6] "Total running time: 0.05061936378479 secs"
```
...
#> [1] "Complete log:"                                   
#> [2] "✔ sqrt() ran successfully at 2022-05-10 21:54:30"
#> [3] "Total running time: 0.000281572341918945 secs"
...
r_sqrt(-10) |>
  read_log()
#> [1] "Complete log:"                                                                             
#> [2] "✘ sqrt() ran unsuccessfully with following exception: NaNs produced at 2022-05-10 21:54:30"
#> [3] "Total running time: 0.000281095504760742 secs"
...
record(my_f, strict = 3)(10) |>
                         read_log()
#> [1] "Complete log:"                                                                                   
#> [2] "✘ my_f() ran unsuccessfully with following exception: this is a message\n at 2022-05-10 21:54:30"
#> [3] "Total running time: 0.000349044799804688 secs"
```
...
#> 1          1 ✔ Success select     "height,mass,spec… NA      2022-05-10 21:54:30
#> 2          2 ✔ Success group_by   "species,sex"      NA      2022-05-10 21:54:30
#> 3          3 ✔ Success filter     "sex != \"male\""  NA      2022-05-10 21:54:30
#> 4          4 ✔ Success summarise  "mean(mass, na.rm… NA      2022-05-10 21:54:30
